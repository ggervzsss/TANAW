...
SCHEMA_STATEMENTS = (
    ...
    """,
    """
    create table camera_monitoring_states (
        camera_id integer primary key,
    ...
    """,
    """
    create table enterprise_occupancy_state (
    ...
    """
    create index idx_count_events_camera_recorded_at
        on count_events(camera_id, recorded_at)
    """,
    """
    create index idx_count_events_submitted_report_id
        on count_events(submitted_report_id)
    """,
    "create index idx_count_events_synced_at on count_events(synced_at)",
    """
    ...
    """,
    """
    create table report_camera_totals (
    ...
    """,
    "create index idx_visitor_identities_expires_at on visitor_identities(expires_at)",
    "create index idx_visitor_identities_status on visitor_identities(identity_status)",
    """
    create table visitor_identity_prototypes (
    ...
    """,
    """
    create index idx_visitor_identity_prototypes_model
...
CHECKSUM = hashlib.sha256("\0".join(SCHEMA_STATEMENTS).encode()).hexdigest()
