...
from app.storage.repositories.occupancy_event_repository import OccupancyEventRepository
...
class LocalDataStore:
    def __init__(self, app_data_dir: str | None = None, enterprise_id: str | None = None) -> None:
        ...
        self._occupancy_events = OccupancyEventRepository(self._database)
    ...
    def append_count_event(self, payload: dict[str, Any], recorded_at: str | None = None) -> str:
        return self._occupancy_events.append(payload, recorded_at)
    ...
    def record_occupancy_correction(
        ...
        *,
        ...
        return self._occupancy_events.record_correction(
    ...
    def enterprise_occupancy(self) -> int:
        return self._occupancy_events.current_occupancy()

    def list_occupancy_corrections(self, limit: int = 100) -> list[dict[str, Any]]:
        return self._occupancy_events.list_corrections(limit)
