...
export function resolveCameraCredential(value: unknown, existing?: SecureCameraCredential): SecureCameraCredential {
  ...
  const password = replacement && !isMaskedCameraPassword(replacement) ? replacement : existing?.password;
