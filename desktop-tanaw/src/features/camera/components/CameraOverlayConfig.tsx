...
import { buildTripwireSvgPath, clampPoint, createTripwireLine, getTripwireAnchors, normalizeTripwireLine } from "../utils/tripwire-path";
import { findNearestPointIndex, getDefaultTripwires, getPointerPercent, insertPointAtNearestSegment, isFullFrameRoi, midpointOfLongestSegment, normalizeTripwires } from "../model/camera-overlay";
