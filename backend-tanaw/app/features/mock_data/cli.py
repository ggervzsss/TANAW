...
ENTERPRISES = (
    MockEnterprise(
        "Pacita Convention Hall",
        "events venue",
        "Ana Reyes",
        "Pacita I",
        "Pacita Avenue, Pacita I, San Pedro, Laguna 4023",
        14.3417,
        121.0608,
        "pacita.convention@tanaw.test",
        "+639171110001",
    ),
    MockEnterprise(
        ...
        "Marco Santos",
        "Sampaguita",
        "Sampaguita Road, San Pedro, Laguna 4023",
        14.3544,
        121.0482,
        "sampaguita.resort@tanaw.test",
        "+639171110002",
    ),
    MockEnterprise(
        "Poblacion Heritage Center",
        "tourism",
        "Lia Cruz",
        "Poblacion",
        "Mabini Street, Poblacion, San Pedro, Laguna 4023",
        14.3594,
        121.0571,
        "poblacion.heritage@tanaw.test",
        "+639171110003",
    ),
    MockEnterprise(
        "Langgam Trade Arcade",
        "business",
        "Jose Dizon",
        "Langgam",
        "National Highway, Langgam, San Pedro, Laguna 4023",
        14.3197,
        121.0663,
        "langgam.arcade@tanaw.test",
        "+639171110004",
    ),
    MockEnterprise(
        "San Antonio Event Pavilion",
        "events venue",
        "Mila Bautista",
        "San Antonio",
        "San Antonio Avenue, San Pedro, Laguna 4023",
        14.3481,
        121.0706,
        "sanantonio.pavilion@tanaw.test",
        "+639171110005",
    ),
)
...
async def create_accounts(db: AsyncSession, run_id: str) -> dict[str, list[Account]]:
    password_hash = hash_password(TEST_ACCOUNT_PASSWORD)
