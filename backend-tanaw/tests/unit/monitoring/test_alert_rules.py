...
from app.features.monitoring.router import (
...
from app.features.monitoring.telemetry import gateway_status_for_snapshot
from app.features.monitoring.visitor_insights import (
