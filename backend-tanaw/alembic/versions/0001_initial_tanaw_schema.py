...
from app.db.migrations import canonical_schema_fingerprint
...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [{"singleton_id": 1, "schema_fingerprint": canonical_schema_fingerprint()}],
    )
    op.create_table(
        "accounts",
...
def downgrade() -> None:
    ...
    op.drop_table("tanaw_schema_identity")
    op.drop_index(
        "uq_realtime_outbox_pending_coalesce",
