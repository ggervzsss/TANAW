  ...
  return {
    ...
    currentRevision: {
      ...
      coverage: {
        ...
        monitoredSeconds: 2678390,
        expectedSeconds: 2678400,
        coverageRatio: 0.999996,
        gapCount: 1,
        gaps: [{ reason: "stream_unavailable", durationSeconds: 10 }],
      },
      metrics: [
...
export function enterpriseReportDetailFixture(overrides: Partial<EnterpriseReportDetail> = {}): EnterpriseReportDetail {
  ...
  return {
    ...
    revisions: [
      {
        ...
        demographics: [
          { demographicFactId: "00000000-0000-0000-0000-000000000901", dimension: "residence", value: "local", count: 12, percentage: "0.1000", provenance: "operator_entered", quality: "confirmed" },
        ],
        sourceBatches: [
          {
            batchId: "00000000-0000-0000-0000-000000001001",
            cameraId: "00000000-0000-0000-0000-000000001101",
            eventCount: 10,
            eventSequenceStart: 100,
            eventSequenceEndExclusive: 110,
    ...
    reviewEvents: [
      {
        reviewEventId: "00000000-0000-0000-0000-000000001201",
        reportRevisionId: summary.currentRevisionId,
        eventType: "accepted",
        fromState: "submitted",
        toState: "accepted",
        actor: { accountId: "00000000-0000-0000-0000-000000001301", displayName: "Recorded Staff", role: "staff" },
        reason: "Evidence verified.",
        commandId: "00000000-0000-0000-0000-000000001401",
        expectedVersion: 1,
        resultingVersion: 2,
...
export function finalReportListFixture(overrides: Partial<FinalReportListItem> = {}): FinalReportListItem {
  return {
    ...
    currentVersion: {
      ...
      artifacts: [
        {
          artifactId: "00000000-0000-0000-0000-000000001701",
          status: "ready",
          templateVersion: "official-final-report-v1",
          mimeType: "application/pdf",
          contentHash: `sha256:${"4".repeat(64)}`,
          generationAttempts: 1,
          lastErrorCode: null,
          generatedAt: "2026-08-02T01:01:00Z",
...
export function finalReportDetailFixture(overrides: Partial<FinalReportDetail> = {}): FinalReportDetail {
  ...
  return {
    ...
    selectedVersion: {
      ...
      scopeMembers: [
        {
          scopeMemberId: "00000000-0000-0000-0000-000000001801",
          reportingObligationId: "00000000-0000-0000-0000-000000000401",
          enterpriseId: "00000000-0000-0000-0000-000000000501",
          enterpriseOfficialCode: "ENT-001",
          enterpriseName: "Frozen Enterprise",
          enterpriseCategory: "Attraction",
          siteId: "00000000-0000-0000-0000-000000000601",
          siteCode: "SITE-001",
      ...
      items: [
        {
          finalReportItemId: "00000000-0000-0000-0000-000000001901",
          reportingObligationId: "00000000-0000-0000-0000-000000000401",
          reportRevisionId: "00000000-0000-0000-0000-000000000301",
          sourcePayloadHash: `sha256:${"1".repeat(64)}`,
        },
      ],
      metrics: [
        {
          metricFactId: "00000000-0000-0000-0000-000000002001",
          definition: "entries",
          definitionVersion: 1,
          value: "0.100000",
          unit: "events",
    ...
    events: [
      {
        finalReportEventId: "00000000-0000-0000-0000-000000002201",
        finalReportVersionId: summary.currentVersionId,
        eventType: "version_finalized",
        actorAccountId: "00000000-0000-0000-0000-000000001301",
        actorDisplayName: "Recorded Staff",
        actorRole: "staff",
        commandId: "00000000-0000-0000-0000-000000002301",
        expectedVersion: 0,
        resultingVersion: 1,
        reason: null,
...
export function complianceFixture(overrides: Partial<PeriodComplianceResource> = {}): PeriodComplianceResource {
  return {
    ...
    obligations: [
      {
        obligationId: "00000000-0000-0000-0000-000000000401",
        enterpriseId: "00000000-0000-0000-0000-000000000501",
        enterpriseOfficialCode: "ENT-001",
        enterpriseName: "Frozen Enterprise",
        siteId: "00000000-0000-0000-0000-000000000601",
      ...
      {
        obligationId: "00000000-0000-0000-0000-000000000402",
        enterpriseId: "00000000-0000-0000-0000-000000000502",
        enterpriseOfficialCode: "ENT-002",
        enterpriseName: "Missing Enterprise",
...
function metric(definition: string, value: string, unit: string, quality: "confirmed" | "estimated", metricFactId = "00000000-0000-0000-0000-000000000701") {
  return {
    ...
    unit,
    grain: "site" as const,
    windowStart: periodFixture.startsAt,
    windowEnd: periodFixture.endsAt,
    timezone: "Asia/Manila" as const,
    provenance: "camera_derived" as const,
    quality,
    coverage: { evidenceStatus: "recorded" as const, monitoredSeconds: 2678390, expectedSeconds: 2678400, coverageRatio: 0.999996, gapCount: 1 },
  };
}
