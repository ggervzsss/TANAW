...
} from "./systemDisplayPreferences";

export function SystemDisplayPreferencesProvider({ authenticated, accountId, children }: { authenticated: boolean; accountId?: string; children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (!authenticated || !accountId) return undefined;
    let disposed = false;
  ...
  }, [accountId, authenticated, loadRevision]);
