...
export function getPortalTopbarThemeClasses(resolvedTheme: ResolvedTheme) {
  ...
  return {
    ...
    dayImage: isDark ? "opacity-0" : "opacity-[0.38]",
    nightImage: isDark ? "opacity-[0.5]" : "opacity-0",
    imageTreatment: isDark ? "brightness-75 saturate-75 contrast-105" : "brightness-95 saturate-90",
    overlay: isDark
      ? "bg-[linear-gradient(90deg,rgba(1,8,11,0.98)_0%,rgba(4,24,20,0.9)_48%,rgba(8,38,30,0.54)_100%)]"
